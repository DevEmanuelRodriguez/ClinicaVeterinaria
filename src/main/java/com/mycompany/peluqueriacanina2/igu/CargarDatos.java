...
public class CargarDatos extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        // apunta a la controladora de logica para que desde ahí se llame a la controladoraPersistencia
        ...
        control.guardar(nomMasco, raza, color, observaciones, alergico, atenEsp, nomDuenio, celDuenio);

        //PopUp para decir que ya se han guardado los datos
