...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    public ModificarDatos(int num_cliente) {
        ...
        initComponents();
        //initComponents se encarga de generar la interfaz
        //cuando la interfaz se carge podemos cargar los Datos
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(255, 238, 147));
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        jPanel5.setBackground(new java.awt.Color(255, 238, 147));
        jPanel5.setPreferredSize(new java.awt.Dimension(1000, 600));

        jPanel1.setBackground(new java.awt.Color(255, 238, 147));
        jPanel1.setForeground(new java.awt.Color(255, 238, 147));

        jLabel1.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 0));
        jLabel1.setText("Atención Especial:");

        txtColor.setBackground(new java.awt.Color(237, 219, 205));
        ...
        txtNombre.setBackground(new java.awt.Color(237, 219, 205));
        ...
        txtRaza.setBackground(new java.awt.Color(237, 219, 205));
        ...
        cmbAlergico.setBackground(new java.awt.Color(237, 219, 205));
        cmbAlergico.setForeground(new java.awt.Color(51, 51, 51));
        ...
        cmbAtencionEspecial.setBackground(new java.awt.Color(237, 219, 205));
        cmbAtencionEspecial.setForeground(new java.awt.Color(51, 51, 51));
        ...
        txtCelDuenio.setBackground(new java.awt.Color(237, 219, 205));
        txtCelDuenio.setForeground(new java.awt.Color(51, 51, 51));
        ...
        txtNomDuenio.setBackground(new java.awt.Color(237, 219, 205));
        txtNomDuenio.setForeground(new java.awt.Color(51, 51, 51));
        ...
        txtObservaciones.setBackground(new java.awt.Color(237, 219, 205));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cmbAtencionEspecial, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel8, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(txtCelDuenio, javax.swing.GroupLayout.PREFERRED_SIZE, 255, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtNomDuenio, javax.swing.GroupLayout.PREFERRED_SIZE, 255, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        // TOMAMOS TODOS LOS DATOS DE LA MASCOTA
        ...
        //TOMAMOS LOS DATOS DEL DUEÑO
        String nomDuenio = txtNomDuenio.getText();
        String celDuenio = txtCelDuenio.getText();

        /*El parametro masco el el objeto de la mascota antigua 
        sin modificar y con eso nos posicionamos en la direccion 
        de memoria a la que pertenece y el ID del dueño*/
        control.modificarMascota(masco, nomMasco, raza, color, observaciones, alergico, atenEsp, nomDuenio, celDuenio);

        //mensaje que todo salio bien
        mostrarMensaje("Se ha editado correctamente", "info", "Edición correcta");
        
        //Para cargar los nuevos datos en la tabla llamamos nuevamente la ventana de VerDatos y asi se actualizan
        VerDatos pantallaVerDatos = new VerDatos();
        pantallaVerDatos.setVisible(true);
        pantallaVerDatos.setLocationRelativeTo(null);

        //Cerramos la ventana  ModificarDatos con lo siguiente
        this.dispose();
    ...
    //Cargamos los datos originales SIN MODIFICAR
    private void CargarDatos(int num_cliente) {
        this.masco = control.traerMascota(num_cliente);

        //ponemos los valores en los fieldtext
        ...
        //El combo comienza con un "0","1".... debemos evaluar el valor y en funcion a eso mostrar lo que hay en el combo
